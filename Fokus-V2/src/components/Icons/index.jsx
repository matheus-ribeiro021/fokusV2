// Importa os componentes SVG, Círculo e Caminho para desenhar vetores
import Svg, { Circle, Path } from 'react-native-svg';

// Ícone que representa o botão de play
export const IconPlay = () => {
    // Retorna o desenho do triângulo de reprodução
    return (

        <Svg width="11" height="15" viewBox="0 0 11 15" fill="none">
            {/* Traça o caminho que forma o triângulo do play */}
            <Path d="M0.015625 0.473022L10.9844 7.4574L0.015625 14.4418V0.473022Z" fill="#021123" />
        </Svg>
    )
}

// Ícone que representa pausa
export const IconPause = () => {
    // Retorna o desenho de duas barras verticais
    return (

        <Svg width="12" height="15" viewBox="0 0 12 15" fill="none">
            {/* Desenha as duas barras que simbolizam a pausa */}
            <Path d="M8.01562 0.473022H12V14.4418H8.01562V0.473022ZM0 14.4418V0.473022H3.98438V14.4418H0Z" fill="#021123" />
        </Svg>
    )
}

// Ícone circular com um símbolo de mais
export const IconPlus = () => {
    // Retorna o SVG responsável por indicar adição
    return (

        <Svg width="25" height="24" viewBox="0 0 25 24" fill="none">
            {/* Traça o círculo externo e o símbolo de mais centralizado */}
...
// Ícone que representa a ação de salvar
export const IconSave = () => {
    // Retorna o símbolo de disquete com detalhes internos
    return (
    
        <Svg width="12" height="12" viewBox="0 0 12 12" fill="none">
            {/* Desenha as formas que imitam um disquete antigo */}
...
// Ícone que mostra um círculo preenchido ou não com um check
export const IconCheck = ({ checked }) => {
    // Retorna o círculo que pode mudar de cor conforme o estado
    return (
 
        <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            {/* Desenha o círculo externo, mudando a cor de fundo quando marcado */}
            <Circle cx="12" cy="12" r="12" fill={checked ? '#00F4BF' : 'white'} />
            {/* Acrescenta o caminho do símbolo de check dentro do círculo */}
...
// Ícone que representa o ato de editar
export const IconPencil = () => {
    // Retorna o desenho estilizado de um lápis
    return (
  
        <Svg width="18" height="18" viewBox="0 0 18 18" fill="none">
            {/* Traça o formato do lápis, incluindo ponta e corpo */}
...
// Ícone que simboliza a ação de apagar
export const IconTrash = () => {
    // Retorna o desenho de uma lixeira simplificada
    return (
      
        <Svg width="14" height="18" viewBox="0 0 14 18" fill="none">
            {/* Desenha o corpo e a tampa da lixeira em formato estilizado */}
